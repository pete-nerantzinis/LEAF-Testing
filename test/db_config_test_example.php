...
class DB_Config
{
    ...
    public $dbName = 'test_portal_database_name';

    public $dbUser = 'test_portal_username';

    public $dbPass = 'test_portal_password';
}
...
class Test_Config
{
    ...
    public $phonedbName = 'test_user_database';

    public $phonedbUser = 'test_user_username';

    public $phonedbPass = 'test_user_password';
}
