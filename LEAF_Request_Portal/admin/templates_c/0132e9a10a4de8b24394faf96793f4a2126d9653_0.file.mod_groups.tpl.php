...
/* Smarty version 3.1.33, created on 2021-04-28 00:12:13
  from '/var/www/html/LEAF_Request_Portal/admin/templates/mod_groups.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6088a85d3ec538_30485685',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0132e9a10a4de8b24394faf96793f4a2126d9653' => 
    array (
      0 => '/var/www/html/LEAF_Request_Portal/admin/templates/mod_groups.tpl',
      1 => 1619564206,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:partial_layouts/left_uag_nav.tpl' => 1,
    'file:../../../libs/smarty/loading_spinner.tpl' => 1,
...
function content_6088a85d3ec538_30485685 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="leaf-center-content">

    <!-- LEFT SIDE NAV -->
    <?php $_smarty_tpl->_assignInScope('left_uag_content', "
        <aside class='sidenav'>
    ...
    ");?>
    <?php $_smarty_tpl->_subTemplateRender("file:partial_layouts/left_uag_nav.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('contentLeft'=>((string)$_smarty_tpl->tpl_vars['left_uag_content']->value)), 0, false);
?>
...
<!--Loading Modal-->
<?php $_smarty_tpl->_subTemplateRender("file:../../../libs/smarty/loading_spinner.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('title'=>'User Groups'), 0, false);
?>
...
let tz = '<?php echo $_smarty_tpl->tpl_vars['timeZone']->value;?>
';
/* <![CDATA[ */
...
function removeMember(groupID, userID) {
    $.ajax({
        type: 'DELETE',
        url: "../api/group/" + groupID + "/members/_" + userID + '&CSRFToken=<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
',
        cache: false
    });
}
...
function setPrimaryAdmin(userID) {
        ...
        data: {'userID': userID, 'CSRFToken': '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'},
        success: function(response) {
        	getPrimaryAdmin();
        },
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                dialog.setContent('<div class="leaf-float-right"><div><button class="usa-button leaf-btn-small" onclick="viewHistory('+groupID+')">View History</button></div>' + button_deleteGroup + '</div>' +
                                    '<a class="leaf-group-link" href="<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/?a=view_group&groupID=' + groupID + '" title="groupID: ' + groupID + '" target="_blank"><h2 role="heading" tabindex="-1">' + groupName + '</h2></a><h3 role="heading" tabindex="-1" class="leaf-marginTop-1rem">Add Employee</h3><div id="employeeSelector"></div></br><div id="employees"></div>');
                                ...
                                for(let i in res) {
                                    ...
                                    if (res[i].active == 1) {
                                        if (res[i].backupID == null) {
                                            ...
                                            $('#employee_table').append('<a href="<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/?a=view_employee&empUID=' + res[i].empUID + '" class="leaf-user-link" title="' + res[i].empUID + ' - ' + res[i].userName + '" target="_blank"><div class="leaf-marginTop-halfRem leaf-bold leaf-font0-9rem">' + toTitleCase(res[i].Fname) + ' ' + toTitleCase(res[i].Lname) + '</a> <span class="leaf-font-normal">' + removeButton + '</span></div>');
                                            // Check for Backups
                                            for (let j in res) {
                                ...
                                $('#deleteGroup_' + groupID).on('click', function() {
                                    ...
                                    dialog_confirm.setSaveHandler(function() {
                                        $.ajax({
                                            type: 'DELETE',
                                            url: "../api/group/" + groupID + '&CSRFToken=<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
',
                                            success: function(response) {
                                                location.reload();
                                            },
...
/api/?a=group/' + groupID + '/local/tag&'
                                                + $.param({tag: '<?php echo $_smarty_tpl->tpl_vars['orgchartImportTag']->value;?>
',
                                                    CSRFToken: '<?php echo $_smarty_tpl->tpl_vars['CSRFToken']->value;?>
'}),
                                            success: function() {
...
'},
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                let counter = 0;
                                for(let i in res) {
                                    $('#adminSummary').append('<a class="leaf-user-link" href="<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/?a=view_employee&empUID=' + res[i].empUID + '" title="' + res[i].empUID + ' - ' + res[i].userName + '" target="_blank"><div class="leaf-marginTop-qtrRem leaf-marginLeft-qtrRem"><span class="leaf-bold leaf-font0-8rem">'+ toTitleCase(res[i].Fname)  + ' ' + toTitleCase(res[i].Lname) +'</span></a> - <a tabindex="0" aria-label="REMOVE ' + toTitleCase(res[i].Fname)  + ' ' + toTitleCase(res[i].Lname) +'" href="#" class="text-secondary-darker leaf-font0-8rem" id="removeAdmin_'+ counter +'">REMOVE</a></div>');
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                for(let i in res) {
                                    ...
                                    {
                                        foundPrimary = true;
                                        $('#primaryAdminSummary').append('<a class="leaf-user-link" href="<?php echo $_smarty_tpl->tpl_vars['orgchartPath']->value;?>
/?a=view_employee&empUID=' + res[i].empUID + '" title="' + res[i].empUID + ' - ' + res[i].userName + '" target="_blank"><div><span class="leaf-bold leaf-font0-9rem">'+ toTitleCase(res[i].Fname)  + ' ' + toTitleCase(res[i].Lname) +'</span></a> - <a tabindex="0" aria-label="Unset '+ toTitleCase(res[i].Fname)  + ' ' + toTitleCase(res[i].Lname) +'" href="#" class="text-secondary-darker leaf-font0-8rem" id="unsetPrimaryAdmin">UNSET</a></div>');
